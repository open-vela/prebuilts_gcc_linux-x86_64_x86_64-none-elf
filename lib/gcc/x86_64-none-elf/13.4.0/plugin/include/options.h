...
enum opt_code
{
  ...
  /* OPT_mcpu_ = 1958, */                    /* -mcpu= */
  OPT_mcrc32 = 1959,                         /* -mcrc32 */
  OPT_mcx16 = 1960,                          /* -mcx16 */
  OPT_mdaz_ftz = 1961,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1962,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1963,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1964,            /* -mdump-tune-features */
  OPT_menqcmd = 1965,                        /* -menqcmd */
  OPT_mf16c = 1966,                          /* -mf16c */
  OPT_mfancy_math_387 = 1967,                /* -mfancy-math-387 */
  OPT_mfentry = 1968,                        /* -mfentry */
  OPT_mfentry_name_ = 1969,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1970,               /* -mfentry-section= */
  OPT_mfma = 1971,                           /* -mfma */
  OPT_mfma4 = 1972,                          /* -mfma4 */
  OPT_mforce_drap = 1973,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1974,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1975,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1976,                       /* -mfpmath= */
  OPT_mfsgsbase = 1977,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1978,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1979, */              /* -mfused-madd */
  OPT_mfxsr = 1980,                          /* -mfxsr */
  /* OPT_mgather = 1981, */                  /* -mgather */
  OPT_mgeneral_regs_only = 1982,             /* -mgeneral-regs-only */
  OPT_mgfni = 1983,                          /* -mgfni */
  OPT_mhard_float = 1984,                    /* -mhard-float */
  OPT_mharden_sls_ = 1985,                   /* -mharden-sls= */
  OPT_mhle = 1986,                           /* -mhle */
  OPT_mhreset = 1987,                        /* -mhreset */
  OPT_miamcu = 1988,                         /* -miamcu */
  OPT_mieee_fp = 1989,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1990,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1991,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1992,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1993,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1994,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1995,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1996,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1997, */            /* -mintel-syntax */
  OPT_mkl = 1998,                            /* -mkl */
  OPT_mlam_ = 1999,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2000,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2001,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2002,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2003,                /* -mlong-double-80 */
  OPT_mlwp = 2004,                           /* -mlwp */
  OPT_mlzcnt = 2005,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2006,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2007,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2008,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2009,                  /* -mmitigate-rop */
  OPT_mmmx = 2010,                           /* -mmmx */
  OPT_mmovbe = 2011,                         /* -mmovbe */
  OPT_mmovdir64b = 2012,                     /* -mmovdir64b */
  OPT_mmovdiri = 2013,                       /* -mmovdiri */
  OPT_mmove_max_ = 2014,                     /* -mmove-max= */
  OPT_mmpx = 2015,                           /* -mmpx */
  OPT_mms_bitfields = 2016,                  /* -mms-bitfields */
  OPT_mmwait = 2017,                         /* -mmwait */
  OPT_mmwaitx = 2018,                        /* -mmwaitx */
  OPT_mneeded = 2019,                        /* -mneeded */
  OPT_mno_align_stringops = 2020,            /* -mno-align-stringops */
  OPT_mno_default = 2021,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2022,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2023,                  /* -mno-push-args */
  OPT_mno_red_zone = 2024,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2025,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2026,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2027,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2028,                          /* -mpc32 */
  OPT_mpc64 = 2029,                          /* -mpc64 */
  OPT_mpc80 = 2030,                          /* -mpc80 */
  OPT_mpclmul = 2031,                        /* -mpclmul */
  OPT_mpcommit = 2032,                       /* -mpcommit */
  OPT_mpconfig = 2033,                       /* -mpconfig */
  OPT_mpku = 2034,                           /* -mpku */
  OPT_mpopcnt = 2035,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2036, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2037,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2038,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2039,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2040,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2041,                        /* -mprfchw */
  OPT_mptwrite = 2042,                       /* -mptwrite */
  OPT_mpush_args = 2043,                     /* -mpush-args */
  OPT_mraoint = 2044,                        /* -mraoint */
  OPT_mrdpid = 2045,                         /* -mrdpid */
  OPT_mrdrnd = 2046,                         /* -mrdrnd */
  OPT_mrdseed = 2047,                        /* -mrdseed */
  OPT_mrecip = 2048,                         /* -mrecip */
  OPT_mrecip_ = 2049,                        /* -mrecip= */
  OPT_mrecord_mcount = 2050,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2051,                 /* -mrecord-return */
  OPT_mred_zone = 2052,                      /* -mred-zone */
  OPT_mregparm_ = 2053,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2054,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2055,                           /* -mrtd */
  OPT_mrtm = 2056,                           /* -mrtm */
  OPT_msahf = 2057,                          /* -msahf */
  /* OPT_mscatter = 2058, */                 /* -mscatter */
  OPT_mserialize = 2059,                     /* -mserialize */
  OPT_msgx = 2060,                           /* -msgx */
  OPT_msha = 2061,                           /* -msha */
  OPT_mshstk = 2062,                         /* -mshstk */
  OPT_mskip_rax_setup = 2063,                /* -mskip-rax-setup */
  OPT_msoft_float = 2064,                    /* -msoft-float */
  OPT_msse = 2065,                           /* -msse */
  OPT_msse2 = 2066,                          /* -msse2 */
  OPT_msse2avx = 2067,                       /* -msse2avx */
  OPT_msse3 = 2068,                          /* -msse3 */
  OPT_msse4 = 2069,                          /* -msse4 */
  OPT_msse4_1 = 2070,                        /* -msse4.1 */
  OPT_msse4_2 = 2071,                        /* -msse4.2 */
  OPT_msse4a = 2072,                         /* -msse4a */
  /* OPT_msse5 = 2073, */                    /* -msse5 */
  OPT_msseregparm = 2074,                    /* -msseregparm */
  OPT_mssse3 = 2075,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2076,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 2079, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2080,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2081,                  /* -mstackrealign */
  OPT_mstore_max_ = 2082,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2083,            /* -mstringop-strategy= */
  OPT_mstv = 2084,                           /* -mstv */
  OPT_mtbm = 2085,                           /* -mtbm */
  OPT_mtls_dialect_ = 2086,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2087,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2088,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2089,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2090,                         /* -mtune= */
  OPT_muintr = 2091,                         /* -muintr */
  OPT_munroll_only_small_loops = 2092,       /* -munroll-only-small-loops */
  OPT_mvaes = 2093,                          /* -mvaes */
  OPT_mveclibabi_ = 2094,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2095,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2096,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2097,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2098,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2099,                      /* -mwbnoinvd */
  OPT_mwidekl = 2100,                        /* -mwidekl */
  OPT_mx32 = 2101,                           /* -mx32 */
  OPT_mxop = 2102,                           /* -mxop */
  OPT_mxsave = 2103,                         /* -mxsave */
  OPT_mxsavec = 2104,                        /* -mxsavec */
  OPT_mxsaveopt = 2105,                      /* -mxsaveopt */
  OPT_mxsaves = 2106,                        /* -mxsaves */
  OPT_n = 2107,                              /* -n */
  OPT_name_sort = 2108,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2109,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2110,              /* -no-integrated-cpp */
  OPT_no_pie = 2111,                         /* -no-pie */
  OPT_nocpp = 2112,                          /* -nocpp */
  OPT_nodefaultlibs = 2113,                  /* -nodefaultlibs */
  OPT_nolibc = 2114,                         /* -nolibc */
  OPT_nophoboslib = 2115,                    /* -nophoboslib */
  OPT_nostartfiles = 2116,                   /* -nostartfiles */
  OPT_nostdinc = 2117,                       /* -nostdinc */
  OPT_nostdinc__ = 2118,                     /* -nostdinc++ */
  OPT_nostdlib = 2119,                       /* -nostdlib */
  OPT_nostdlib__ = 2120,                     /* -nostdlib++ */
  OPT_o = 2121,                              /* -o */
  OPT_objects = 2122,                        /* -objects */
  OPT_p = 2123,                              /* -p */
  OPT_pass_exit_codes = 2124,                /* -pass-exit-codes */
  /* OPT_pedantic = 2125, */                 /* -pedantic */
  OPT_pedantic_errors = 2126,                /* -pedantic-errors */
  OPT_pg = 2127,                             /* -pg */
  OPT_pie = 2128,                            /* -pie */
  OPT_pipe = 2129,                           /* -pipe */
  OPT_print_file_name_ = 2130,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2131,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2132,          /* -print-multi-directory */
  OPT_print_multi_lib = 2133,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2134,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2135,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2136,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2137,               /* -print-prog-name= */
  OPT_print_search_dirs = 2138,              /* -print-search-dirs */
  OPT_print_sysroot = 2139,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2140,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2141,                    /* -print-value */
  OPT_quiet = 2142,                          /* -quiet */
  OPT_r = 2143,                              /* -r */
  OPT_remap = 2144,                          /* -remap */
  OPT_reverse_sort = 2145,                   /* -reverse-sort */
  OPT_s = 2146,                              /* -s */
  OPT_save_temps = 2147,                     /* -save-temps */
  OPT_save_temps_ = 2148,                    /* -save-temps= */
  OPT_shared = 2149,                         /* -shared */
  OPT_shared_libgcc = 2150,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2151,               /* -shared-libphobos */
  OPT_size_sort = 2152,                      /* -size-sort */
  /* OPT_specs = 2153, */                    /* -specs */
  OPT_specs_ = 2154,                         /* -specs= */
  OPT_static = 2155,                         /* -static */
  OPT_static_libasan = 2156,                 /* -static-libasan */
  OPT_static_libgcc = 2157,                  /* -static-libgcc */
  OPT_static_libgfortran = 2158,             /* -static-libgfortran */
  OPT_static_libgm2 = 2159,                  /* -static-libgm2 */
  OPT_static_libgo = 2160,                   /* -static-libgo */
  OPT_static_libhwasan = 2161,               /* -static-libhwasan */
  OPT_static_liblsan = 2162,                 /* -static-liblsan */
  OPT_static_libmpx = 2163,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2164,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2165,               /* -static-libphobos */
  OPT_static_libquadmath = 2166,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2167,               /* -static-libstdc++ */
  OPT_static_libtsan = 2168,                 /* -static-libtsan */
  OPT_static_libubsan = 2169,                /* -static-libubsan */
  OPT_static_pie = 2170,                     /* -static-pie */
  /* OPT_std_c__03 = 2171, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2172, */                /* -std=c++0x */
  OPT_std_c__11 = 2173,                      /* -std=c++11 */
  OPT_std_c__14 = 2174,                      /* -std=c++14 */
  OPT_std_c__17 = 2175,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2176, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2177, */                /* -std=c++1z */
  OPT_std_c__20 = 2178,                      /* -std=c++20 */
  OPT_std_c__23 = 2179,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2180, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2181, */                /* -std=c++2b */
  OPT_std_c__98 = 2182,                      /* -std=c++98 */
  OPT_std_c11 = 2183,                        /* -std=c11 */
  OPT_std_c17 = 2184,                        /* -std=c17 */
  /* OPT_std_c18 = 2185, */                  /* -std=c18 */
  /* OPT_std_c1x = 2186, */                  /* -std=c1x */
  OPT_std_c2x = 2187,                        /* -std=c2x */
  /* OPT_std_c89 = 2188, */                  /* -std=c89 */
  OPT_std_c90 = 2189,                        /* -std=c90 */
  OPT_std_c99 = 2190,                        /* -std=c99 */
  /* OPT_std_c9x = 2191, */                  /* -std=c9x */
  OPT_std_f2003 = 2192,                      /* -std=f2003 */
  OPT_std_f2008 = 2193,                      /* -std=f2008 */
  OPT_std_f2008ts = 2194,                    /* -std=f2008ts */
  OPT_std_f2018 = 2195,                      /* -std=f2018 */
  OPT_std_f95 = 2196,                        /* -std=f95 */
  OPT_std_gnu = 2197,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2198, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2199, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2200,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2201,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2202,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2203, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2204, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2205,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2206,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2207, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2208, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2209,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2210,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2211,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2212, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2213, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2214,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2215, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2216,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2217,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2218, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2219, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2220,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2221, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2222, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2223, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2224, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2225, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2226,                     /* -std=legacy */
  OPT_stdlib_ = 2227,                        /* -stdlib= */
  OPT_symbol_ = 2228,                        /* -symbol= */
  OPT_symbolic = 2229,                       /* -symbolic */
  OPT_t = 2230,                              /* -t */
  OPT_time = 2231,                           /* -time */
  OPT_time_ = 2232,                          /* -time= */
  OPT_traditional = 2233,                    /* -traditional */
  OPT_traditional_cpp = 2234,                /* -traditional-cpp */
  OPT_tree_stats = 2235,                     /* -tree-stats */
  OPT_trigraphs = 2236,                      /* -trigraphs */
  OPT_type_stats = 2237,                     /* -type-stats */
  OPT_u = 2238,                              /* -u */
  OPT_undef = 2239,                          /* -undef */
  OPT_v = 2240,                              /* -v */
  OPT_version = 2241,                        /* -version */
  OPT_w = 2242,                              /* -w */
  OPT_wrapper = 2243,                        /* -wrapper */
  OPT_x = 2244,                              /* -x */
  OPT_z = 2245,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
